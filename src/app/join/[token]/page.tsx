...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça para a pessoa que te convidou enviar um novo link.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo — leva poucos segundos para gerar.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não conseguimos verificar este convite agora. Tente atualizar a página em um momento.',
  },
};
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                diferente. O link do convite permanece válido enquanto não
                expirar.
              </p>
            </div>
