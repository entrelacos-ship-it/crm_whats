      ...
      <DialogContent className="border-border bg-popover text-popover-foreground sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            ...
            aparecem em todo contato e na ação de automação “Atualizar Campo
            do Contato”.
          </DialogDescription>
        </DialogHeader>
        <CustomFieldsPanel />
...
export function CustomFieldsPanel() {
  ...
  async function handleDelete(field: CustomField) {
    if (
      !window.confirm(
        `Excluir "${field.field_name}"? Isso também remove o valor salvo em todos os contatos. Não pode ser desfeito.`
      )
    ) {
      return;
    }
