    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Contagem de todo negócio neste pipeline que não está marcado como Perdido. Negócios Ganhos ainda são incluídos."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: o valor de cada negócio aberto × a probabilidade da sua etapa. Primeira etapa ≈ 10%, etapas progridem até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
