  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Insira novamente o Access Token para salvar as alterações');
        setSaving(false);
        return;
      }
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciais salvas e verificadas. O registro de entrada foi pulado (sem PIN) — veja o status de Registro abaixo.',
          { duration: 10000 },
        );
        setPin('');
      } else {
      ...
      <div className="space-y-6">
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  abaixo e clique em Salvar Configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes da existência do rastreamento
                  de registro, ou o registro foi pulado. Insira o
                  PIN de verificação em duas etapas abaixo e clique em
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                para um número de <strong className="text-muted-foreground">produção</strong>. Defina-o em{' '}
                ...
                caso contrário, a Meta direciona os eventos de entrada para o
                app que os reivindicou por último (o sintoma que afeta números
                secundários sob um WABA compartilhado).{' '}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como callback de webhook no Painel de Apps da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
