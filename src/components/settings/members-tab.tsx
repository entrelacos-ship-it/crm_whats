...
const EDITABLE_ROLES: { value: AccountRole; label: string; hint: string }[] = [
  ...
  { value: 'agent', label: 'Agente', hint: 'Usa recursos; sem configurações' },
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite em texto puro é exibida apenas uma vez na
              criação por segurança — para compartilhar novamente, revogue
              o convite abaixo e crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? Ele(a) será desconectado(a) desta conta e receberá
              uma nova conta pessoal no próximo login. O login dele(a) não
              é excluído.
            </DialogDescription>
          </DialogHeader>
