...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova Mensagem Recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira vez que esse contato envia mensagem (funciona também para contatos adicionados manualmente)",
  },
  ...
  { value: "time_based", label: "Baseado em Tempo", hint: "Em uma programação recorrente" },
]
    ...
    <div className="space-y-2">
      <div>
        ...
        <Input
          ...
          placeholder="ex.: preço, agendar demonstração, falar com vendas"
          className="bg-muted text-foreground"
        />
      </div>
      <div>
    ...
    case "close_conversation":
      return (
        <p className="text-xs text-muted-foreground">
          Define o status da conversa como &quot;fechada&quot;. Não precisa de configuração.
        </p>
      )
    default:
      return null
